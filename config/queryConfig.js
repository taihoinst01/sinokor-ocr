...
var myApprovalConfig = {
    ...
    selectApprovalDtlList:
        `SELECT SEQNUM, DOCNUM, IMGID, IMGFILESTARTNO, IMGFILEENDNO, ENTRYNO, STATEMENTDIV, CONTRACTNUM, OGCOMPANYCODE, OGCOMPANYCODECOORDI, OGCOMPANYNAME, OGCOMPANYNAMECOORDI, BROKERCODE, BROKERCODECOORDI,
                BROKERNAME, BROKERNAMECOORDI, CTNM, CTNMCOORDI, INSSTDT, INSSTDTCOORDI, INSENDDT, INSENDDTCOORDI, UY, UYCOORDI, CURCD, CURCDCOORDI, PAIDPERCENT, PAIDPERCENTCOORDI, PAIDSHARE, PAIDSHARECOORDI,
                OSLPERCENT, OSLPERCENTCOORDI, OSLSHARE, OSLSHARECOORDI, GROSSPM, GROSSPMCOORDI, PM, PMCOORDI, PMPFEND, PMPFENDCOORDI, PMPFWOS, PMPFWOSCOORDI, XOLPM, XOLPMCOORDI, RETURNPM, RETURNPMCOORDI,
                GROSSCN, GROSSCNCOORDI, CN, CNCOORDI, PROFITCN, PROFITCNCOORDI, BROKERAGE, BROKERAGECOORDI, TAX, TAXCOORDI, OVERRIDINGCOM, OVERRIDINGCOMCOORDI, CHARGE, CHARGECOORDI, PMRESERVERTD1, PMRESERVERTD1COORDI,
                PFPMRESERVERTD1, PFPMRESERVERTD1COORDI, PMRESERVERTD2, PMRESERVERTD2COORDI, PFPMRESERVERTD2, PFPMRESERVERTD2COORDI, CLAIM, CLAIMCOORDI, LOSSRECOVERY, LOSSRECOVERYCOORDI, CASHLOSS, CASHLOSSCOORDI, 
                CASHLOSSRD, CASHLOSSRDCOORDI, LOSSRR, LOSSRRCOORDI, LOSSRR2, LOSSRR2COORDI, LOSSPFEND, LOSSPFENDCOORDI, LOSSPFWOA, LOSSPFWOACOORDI, INTEREST, INTERESTCOORDI, TAXON, TAXONCOORDI, MISCELLANEOUS, MISCELLANEOUSCOORDI, 
                PMBL, PMBLCOORDI, CMBL, CMBLCOORDI, NTBL, NTBLCOORDI, CSCOSARFRNCNNT2, CSCOSARFRNCNNT2COORDI
           FROM TBL_DOCUMENT_DTL 
          WHERE 1=1 `,
