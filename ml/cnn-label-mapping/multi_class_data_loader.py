...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "./data/batchLearn.train", "Data source for the training data.")
        self.__flags.DEFINE_string("dev_data_file", "./data/batchLearn.dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "./data/batchLearn.cls", "Data source for the class list.")
    ...
    def __load_data_and_labels_test(self, list):
        ...
        for ins in list:
            ...
            x_text.append(data)
            y.append(class_vectors["UNDEFINED"])
    ...
    def __classes(self):
        ...
        sql = "SELECT * FROM TBL_LABEL_MAPPING_CLS"
        curs.execute(sql)
