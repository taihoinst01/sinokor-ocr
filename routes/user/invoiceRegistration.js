        ...
        try {
            ...
            for (var i = 0; i < mlData.mlExportData.length; i++) {
                if (mlData.mlExportData[i][0] == 'Y') {
                    ...
                    if (deptCode[0].DEPT_CD != '') data += '<Col id="secd">' + deptCode[0].DEPT_CD + '</Col>';
                    ...
                    if ('2014999' != '') data += '<Col id="rgstEmpNo">2014999</Col>';
                    if (docInfo[3] != '') data += '<Col id="prinEmpNo">' + docInfo[3] + '</Col>';
                    if (mlData.mlExportData[i][41] != '') data += '<Col id="cscoSaRfrnCnnt2">' + mlData.mlExportData[i][41].replace(/ /gi, '&#32;') + '</Col>';
                    if (mlData.mlExportData[i][15] != '') data += '<Col id="pre">' + mlData.mlExportData[i][15] + '</Col>';
                    if (mlData.mlExportData[i][16] != '') data += '<Col id="prePfinAmt>' + mlData.mlExportData[i][16] + '</Col>';
                    if (mlData.mlExportData[i][17] != '') data += '<Col id="prePfoutAmt>' + mlData.mlExportData[i][17] + '</Col>';
                    if (mlData.mlExportData[i][18] != '') data += '<Col id="xolPre>' + mlData.mlExportData[i][18] + '</Col>';
                    if (mlData.mlExportData[i][19] != '') data += '<Col id="icpreOcpre>' + mlData.mlExportData[i][19] + '</Col>';
                    if (mlData.mlExportData[i][20] != '') data += '<Col id="com>' + mlData.mlExportData[i][20] + '</Col>';
                    if (mlData.mlExportData[i][21] != '') data += '<Col id="pfcom>' + mlData.mlExportData[i][21] + '</Col>';
                    if (mlData.mlExportData[i][22] != '') data += '<Col id="brkg>' + mlData.mlExportData[i][22] + '</Col>';
                    if (mlData.mlExportData[i][23] != '') data += '<Col id="txam>' + mlData.mlExportData[i][23] + '</Col>';
                    if (mlData.mlExportData[i][24] != '') data += '<Col id="rtrcCom>' + mlData.mlExportData[i][24] + '</Col>';
                    if (mlData.mlExportData[i][25] != '') data += '<Col id="cdnCnam>' + mlData.mlExportData[i][25] + '</Col>';
                    if (mlData.mlExportData[i][26] != '') data += '<Col id="prrsCf>' + mlData.mlExportData[i][26] + '</Col>';
                    if (mlData.mlExportData[i][27] != '') data += '<Col id="pfPrrsCf>' + mlData.mlExportData[i][27] + '</Col>';
                    if (mlData.mlExportData[i][28] != '') data += '<Col id="prrsRls>' + mlData.mlExportData[i][28] + '</Col>';
                    if (mlData.mlExportData[i][29] != '') data += '<Col id="pfPrrsRls>' + mlData.mlExportData[i][29] + '</Col>';
                    if (mlData.mlExportData[i][30] != '') data += '<Col id="cla>' + mlData.mlExportData[i][30] + '</Col>';
                    if (mlData.mlExportData[i][31] != '') data += '<Col id="lsRcvyAmt>' + mlData.mlExportData[i][31] + '</Col>';
                    if (mlData.mlExportData[i][32] != '') data += '<Col id="cas>' + mlData.mlExportData[i][32] + '</Col>';
                    if (mlData.mlExportData[i][33] != '') data += '<Col id="casRfn>' + mlData.mlExportData[i][33] + '</Col>';
                    if (mlData.mlExportData[i][34] != '') data += '<Col id="lsresCf>' + mlData.mlExportData[i][34] + '</Col>';
                    if (mlData.mlExportData[i][35] != '') data += '<Col id="lsresRls>' + mlData.mlExportData[i][35] + '</Col>';
                    if (mlData.mlExportData[i][36] != '') data += '<Col id="claPfinAmt>' + mlData.mlExportData[i][36] + '</Col>';
                    if (mlData.mlExportData[i][37] != '') data += '<Col id="claPfoutAmt>' + mlData.mlExportData[i][37] + '</Col>';
                    if (mlData.mlExportData[i][38] != '') data += '<Col id="rsreInt>' + mlData.mlExportData[i][38] + '</Col>';
                    if (mlData.mlExportData[i][39] != '') data += '<Col id="intTxam>' + mlData.mlExportData[i][39] + '</Col>';
                    if (mlData.mlExportData[i][40] != '') data += '<Col id="spyCost>' + mlData.mlExportData[i][40] + '</Col>';
                    data += '</Row>';
                }
            }
            data += '' +
